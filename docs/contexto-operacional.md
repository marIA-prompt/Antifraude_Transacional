...
> **Documento fonte.** Este arquivo é a cópia fiel do briefing operacional recebido e serve
> como referência normativa do projeto. Não editar para registrar análises: os desdobramentos
> ficam em [`arquitetura/as-is.md`](arquitetura/as-is.md),
> [`arquitetura/lacunas-e-riscos.md`](arquitetura/lacunas-e-riscos.md),
> [`arquitetura/to-be.md`](arquitetura/to-be.md) e [`evolucoes/`](evolucoes/).
> Alterações neste arquivo só devem refletir uma nova versão do briefing.
